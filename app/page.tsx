...
function SakuraAppContent() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-[#08000c] select-none font-sans text-white">
      ...
      {/* Mode 1: Full Native 3D Sakura TSX Artwork Experience */}
      {isArtworkStarted ? (
        <SakuraCanvas
          isRunning={true}
          elapsed={0}
              ...
              <div className="flex flex-col gap-2 pt-1">
                ...
                {!isGuest ? (
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-pink-500/20 via-purple-500/20 to-pink-500/20 hover:from-pink-500/40 hover:to-purple-500/40 border border-pink-400/40 rounded-xl py-3 px-4 text-white text-xs font-semibold uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-lg cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className={`w-full border rounded-xl py-3 px-4 text-xs font-semibold uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-lg cursor-pointer ${
                      isGuestJoined
